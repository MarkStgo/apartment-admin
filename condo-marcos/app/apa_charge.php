...
<body>
  <div class="banner">
    ...
    <?php endif; ?>
      <br>
      <?php if ($apartment): ?>
    <h3>Current Debt: <?php echo htmlspecialchars($apartment['deuda']); ?></h3>
<?php else: ?>
    <p>Unexpected data format in the apartments array.</p>
<?php endif; ?>
  </div>
  ...
  <form action="apa_charge_post.php" method="post">
...
<?php endif; ?>
      ...
      <div>
        <h3>Charge</h3>
        <label for="payment-date">Charge Date:</label>
        <input type="date" id="payment-date" name="payment-date" value="<?php echo date('Y-m-d'); ?>"><br><br>

        <label for="payment-method">Charge Concept:</label>
