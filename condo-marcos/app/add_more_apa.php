...
<head>
	...
	<title>Add Additional Apartments</title>
</head>
    <style>
...
<div class="banner">
  ...
  <h1>Add Apartment Profile</h1>
    ...
    echo "<a href='viewCondoApa.php?condo_id=" . $condo_id . "' class='back_btn'>Return</a>";
?>

        <br>
        <br>
        
	<form action="add_more_apa_post.php" method="POST">
        
        
        
        <input type="hidden" id="condo_id" name="condo_id" value="<?php echo $condo_id; ?>">
